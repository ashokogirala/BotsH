...
<html>
 ...
 function overrideClicked(){
        document.forms[1].action='<%=request.getContextPath()%>'+'/CalculateMaxAmt.do?methodToCall=lp_Override';
  ...
  <!--  document.forms[1].cstprocess.disabled=false;   -->
    ...
    var DBMSG='<%=request.getAttribute("msg") %>';
        var result='<%=request.getAttribute("StatusErr") %>';
                                      ...
                                      onclick="return showCalendar('refdate','1','%d-%b-%Y',false,false);"  class="cursorHand">
                                                      ...
                                                      <td>
                                                                     Status Reason:
                                                                        ...
                                                                        <td colspan="4">
                                                                          <html:text property="txtPenReason"   name="CalculateMaxAmt"  readonly="true" size="80"
                                                                           style="background-color:#c0c0c0;border:1px solid #8f8e8e; "/>
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td><div align="center"><Strong>Claim Details </strong></div></td>
      </tr>
      <tr>
