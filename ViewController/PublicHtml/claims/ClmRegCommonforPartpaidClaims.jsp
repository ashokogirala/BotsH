...
//alert('window.navigator.userAgent.indexOf("Firefox") :' +window.navigator.userAgent.indexOf("Firefox"));
  ...
  function showModalWindow(){ 
        ...
        Country='country';
       // var vcomcat="<%= request.getSession().getAttribute("comcatpp") %>";
       var vcomcat="PP";
      ...
      //  if(docum//ent.forms[0].vtfRegNum.value!="")
      //      getclmdetails();
  ...
  <%
        //String comcat=(String)request.getSession().getAttribute("comcatpp");
        String comcat="PP";
        if(comcat==null){
        System.out.println("comcat====null");
       // comcat="1";
        }
         System.out.println("comcat===="+comcat);
