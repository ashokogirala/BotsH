...
<html>
        ...
        if (validateRequired(document.forms[0])){
            ...
            var todate =document.forms[0].elements["TDate"].value;
             ...
             if(comparDates(fromdate,todate)){ 
                window.open("reportJSP/PrintPayTrackDetails.jsp?fromdate="+fromdate+"&todate="+todate,'classPop', "location=1,status=1,scrollbars=1,width=900,height=750,left=100,top=150"); 
           }
    }
  ...
  <body ><html:errors/><html:form action="/PayTrackDetailsAction.do?methodToCall=getPayTrackDetails"
                                 method="post">
      <html:javascript formName="PayTrackDetails"/>
      
                 <table width="100%" border="0" cellspacing="0"
                               cellpadding="1">
                          <tr>
                            <td valign="top" class="head_bgcolor">Payment Track Details</td>
                          </tr>
                          <tr>
                            <td valign="top">
                              <table width="100%"
                                    ...
                                    <tr>
                                      <td style="height:50px;"><table width="100%" border="0" cellspacing="0" cellpadding="3">
                                             ...
                                             <td width="11%">From Date:<span class="red12">*</span>
                                                            ...
                                                            <html:text property="FDate" name="PayTrackDetails" style="width:110px;hight:14px"  readonly="true"/>
                                            ...
                                            <html:text property="TDate" name="PayTrackDetails" style="width:110px;hight:14px" readonly="true"/>
